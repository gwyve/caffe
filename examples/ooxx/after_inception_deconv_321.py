...
job_name = "AIDOOXX_{}".format(resize)
...
mbox_layers = CreateMultiBoxHead_ooxx(net,dim=321,after_inception_deconv = after_inception_deconv, head_inception = head_inception,use_inception = use_inception,use_deconv =use_deconv,
