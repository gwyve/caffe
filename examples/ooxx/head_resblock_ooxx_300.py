...
mbox_layers = CreateMultiBoxHead_ooxx(net,dim=300, head_resblock = head_resblock, head_inception = head_inception,use_inception = use_inception,use_deconv =use_deconv,
